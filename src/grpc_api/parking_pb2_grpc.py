...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in parking_pb2_grpc.py depends on'
...
class ParkingDetectorStub(object):
...
class ParkingDetectorServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ParkingDetectorServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'parking.ParkingDetector', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('parking.ParkingDetector', rpc_method_handlers)
